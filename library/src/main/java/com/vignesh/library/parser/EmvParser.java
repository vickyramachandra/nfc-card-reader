package com.vignesh.library.parser;

import android.util.Log;

import com.vignesh.library.enums.CommandEnum;
import com.vignesh.library.enums.EmvCardScheme;
import com.vignesh.library.enums.SwEnum;
import com.vignesh.library.exception.CommunicationException;
import com.vignesh.library.iso7816emv.EmvTags;
import com.vignesh.library.iso7816emv.EmvTerminal;
import com.vignesh.library.iso7816emv.TLV;
import com.vignesh.library.iso7816emv.TagAndLength;
import com.vignesh.library.model.Afl;
import com.vignesh.library.model.EmvCard;
import com.vignesh.library.model.EmvTransactionRecord;
import com.vignesh.library.model.enums.CurrencyEnum;
import com.vignesh.library.utils.BytesUtils;
import com.vignesh.library.utils.CommandApdu;
import com.vignesh.library.utils.ResponseUtils;
import com.vignesh.library.utils.TlvUtil;
import com.vignesh.library.utils.TrackUtils;
...
public class EmvParser {
	 ...
	 * TAG
	 */
	private static final String TAG = EmvParser.class.getName();
	...
	protected byte[] getGetProcessingOptions(final byte[] pPdol, final IProvider pProvider) throws CommunicationException {
		...
		try {
			...
			Log.e("Construct GPO Command:", ioe.getMessage(), ioe);
		}
